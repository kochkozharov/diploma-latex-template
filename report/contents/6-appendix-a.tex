...
\href{https://github.com/orgs/mai-diploma-kochkozharov/repositories}{\texttt{mai-diploma-kochkozharov}}~\cite{repos-org}.
...
\begin{itemize}
    ...
    \item \textbf{\href{https://github.com/mai-diploma-kochkozharov/diploma-latex-template}{\texttt{diploma-latex-template}}}
        (ветка \texttt{main}). Исходные тексты настоящей выпускной
